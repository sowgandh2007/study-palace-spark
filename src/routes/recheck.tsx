...
function RecheckPage() {
  ...
  return (
    <div className="min-h-screen text-foreground selection:bg-primary/30 pb-20">
      ...
      <main className="mx-auto max-w-2xl px-6 pt-10 space-y-6">
        <div className="glass-card p-8 sm:p-10 text-center space-y-6">
          ...
          <div>
            ...
            <h1 className="text-3xl font-extrabold tracking-tight sm:text-4xl text-white mt-1">Understanding Significantly Improved!</h1>
          </div>

          {/* Before vs After Score Callout */}
          <div className="grid grid-cols-3 gap-3 rounded-2xl border border-white/10 bg-black/40 p-6 items-center font-mono">
            <div>
              <span className="text-xs font-semibold uppercase tracking-wider text-slate-400">Before Repair</span>
              <p className="text-3xl font-bold text-slate-400 mt-1">{beforeScore}%</p>
            </div>
            <div className="border-x border-white/10">
              <span className="text-xs font-semibold uppercase tracking-wider text-success">Improvement</span>
              <p className="text-3xl font-extrabold text-success mt-1">+{improvement} pts</p>
            </div>
            <div>
              <span className="text-xs font-semibold uppercase tracking-wider text-primary">After Repair</span>
              <p className="text-3xl font-extrabold text-primary mt-1">{afterScore}%</p>
            </div>
          </div>
          ...
          <div className="pt-2 flex flex-col sm:flex-row items-center justify-center gap-3">
            <Button asChild size="lg" className="bg-primary hover:bg-primary/90 font-bold shadow-glow w-full sm:w-auto">
              <Link to="/dashboard">View Telemetry Dashboard <ArrowRight className="ml-1.5 size-4" /></Link>
            </Button>
            <Button asChild size="lg" variant="outline" className="border-white/20 bg-white/5 hover:bg-white/10 w-full sm:w-auto">
