...
function LandingPage() {
  ...
  return (
    <>
      ...
      <div className="hidden md:block bg-background min-h-screen pb-28 md:pb-20 bg-[radial-gradient(#d1d8e0_2px,transparent_2px)] bg-[length:30px_30px]">
